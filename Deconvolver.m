classdef Deconvolver < handle
    ...
    %
    % Supports:
    %   Regularizers: Tikhonov,gradient, TV Hessian Schattennnorm
    ...
    methods
        function obj = Deconvolver(psf, varargin)
            ...
            addParameter(p, 'Regularizer', 'tikhonov', ...
                @(x) ismember(x, {'tikhonov', 'tv', 'gradient', 'hessian', 'goods'}));
